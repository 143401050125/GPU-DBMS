...
card_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size), len(column_names["card_df"]))), columns = column_names["card_df"])
account_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size)+1, len(column_names["account_df"]))), columns = column_names["account_df"])
disp_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size)+9, len(column_names["disp_df"]))), columns = column_names["disp_df"])
district_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size)+5, len(column_names["district_df"]))), columns = column_names["district_df"])
loan_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size)+2, len(column_names["loan_df"]))), columns = column_names["loan_df"])
order_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size)+3, len(column_names["order_df"]))), columns = column_names["order_df"])
client_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size), len(column_names["client_df"]))), columns = column_names["client_df"])
trans_df = pd.DataFrame(np.random.randint(0,row_size,size=(np.random.randint(1,row_size), len(column_names["trans_df"]))), columns = column_names["trans_df"])
